<template>
  <div class="w-full flex flex-col justify-center items-center py-10 text-[#454545]">
    <span class="select-none text-[#454545] text-4xl font-light uppercase p-2">register</span>
    <span class="select-none text-[#454545] w-96 text-center font-light py-10">Join [Your Website Name] and enhance your riding experience. <br>Register now and let the adventure begin!</span>
    <div class="flex flex-col p-5 gap-5 w-96 font-light">
      ...
      <div class="flex items-center gap-2 border-b-2 border-[#454545] p-2">
        <font-awesome-icon :icon="['fas', 'lock']" style="color: #454545;" class=""/>
        <input type="password" class="focus:outline-none w-full" v-model="confirmPassword"
    ...
    <div class="flex flex-col items-center justify-center gap-5 font-light">
      ...
      <div class="flex gap-5 justify-center">
        <font-awesome-icon :icon="['fab', 'google']" @click="registerAccountWithGoogle()"
    ...
    registerAccount() {
      if (this.password === this.confirmPassword) {
        createUserWithEmailAndPassword(getAuth(), this.email, this.password)
            .then((data) => {
              useToast().success("Register with success ! Welcome !");
        ...
        this.errMsg = 'Have to be same password'
      }
    },
